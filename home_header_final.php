  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      <div class="navbar-header">
        ...
        echo  '<a class="navbar-brand active" <a href="back_to_exercises.php?error=home">  <span class="glyphicon glyphicon-home  "></span>   e-learning</a>';
        }
        else{
    ...
    <?php } else { ?>
      ...
      <?php $icon = $_SESSION['icon'];
       ...
       <ul class="dropdown-menu">
         ...
         $url = "http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'];
         if (strpos($url, 'lessons/') !==false || strpos($url, 'exercises/') !== false){
         echo  '<li><a href="back_to_exercises.php?error=settings">
...
{?>
    ...
    <li class="panel hidden-xs  active"><a href="back_to_exercises.php?error=lessons">Lessons</a></li>
...
<?php }?>
  ...
  <?php  if($_SESSION['welcome'] != 2){?>
     ...
     <?php } else { ?>
    <li class="panel hidden-xs  active"><a href="back_to_exercises.php?error=ex">Exercises</a></li>
       <?php }
     }
    else
   {?>
  ...
  <?php  if($_SESSION['welcome'] != 2){?>
     ...
     <?php } else { ?>
    <li class="panel hidden-xs  active"><a href="back_to_exercises.php?error=results">Results</a></li>
       <?php }
     }
    else
   {?>
  ...
  <?php  if($_SESSION['welcome'] != 2){?>
     ...
     <?php } else { ?>
    <li class="panel hidden-xs  active"><a href="back_to_exercises.php?error=ch">Charts</a></li>
       <?php }
     }
    else
   {?>
  ...
  <?php  if($_SESSION['welcome'] != 2){?>
     ...
     <?php } else { ?>
    <li class="panel hidden-xs  active"><a href="back_to_exercises.php?error=ci">Change Icon</a></li>
       <?php }
     }
    else
   {?>
  ...
  <?php  if($_SESSION['welcome'] != 2){?>
     ...
     <?php } else { ?>
    <li class="panel hidden-xs  active"><a href="back_to_exercises.php?error=settings">Settings</a></li>
       <?php }
     }
    else
   {?>
